...
class TabWidgetVue extends WidgetVue{
    ...
    private String getHtmlStructure(DataframeVue dataframe, Map field){
        ...
        for(String dfr: field.dataframes){
            ...
            tabHeaders.append(""" <v-tab style ="text-transform:capitalize; color:white;background-color:rgb(199, 210, 243);border-top-left-radius: 45%;border-top-right-radius: 45%;" ripple href="#$dfrName-tab-id" @click.stop='onTabClick("$dfrName")'>${dfrLabel}</v-tab>\n""")
