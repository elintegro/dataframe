    ...
    vueElintegroApplicantDetailsDataframeLayout(ColumnLayoutVue){bean->
        ...
        layoutPlaceHolder = """<v-flex xs12 sm12 md12 lg12 xl12 ><v-card round style ="overflow:hidden;" >
                                  ...
                                  <v-tabs-items v-model="vueElintegroApplicantDetailsDataframe_tab_model" >
                                      ...
                                      <v-tab-item value="vueElintegroCommentPageForApplicantDataframe-tab-id"><vueElintegroCommentPageForApplicantDataframe :vueElintegroCommentPageForApplicantDataframe_prop='this.vueElintegroCommentPageForApplicantDataframe_prop'/></v-tab-item>
                                 </v-tabs-items></v-card>
                                </v-flex>"""
