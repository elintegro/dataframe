...
beans {
	...
	gcMainPageVue(PageDFRegistryVue){ bean ->
		...
		allDataframesList = [
				...
				"vueTechnologiesDataframe","clientProjectEditDataframe","vueClientProjectDataframe",  "vueGettingStartedDataframe", "vueCareersDataframe","vueElintegroApplicantsDataframe",
