...
beans {
	...
	gcMainPageVue(PageDFRegistryVue){ bean ->
		...
		allDataframesList = [
				...
				"vueTechnologiesDataframe","vueClientProjectDataframe","vueCreateProjectForTranslationDataframe","vueTranslatorAssistantDataframe","vueAppsDataframe","vueGettingStartedDataframe", "vueCareersDataframe","vueElintegroApplicantsDataframe",
