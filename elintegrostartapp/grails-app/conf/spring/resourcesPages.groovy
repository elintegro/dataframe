...
beans {
	...
	gcMainPageVue(PageDFRegistryVue){ bean ->
		...
		allDataframesList = [
				...
				"vueNewEmployeeBasicInformationDataframe","vueMapWidgetDataframe","vueAddressDataframe","vueNewEmployeeUploadResumeDataframe","vueNewEmployeeApplicantEditSkillDataframe","vueNewEmployeeApplicantAddSkillDataframe"
				...
				"vueTechnologiesDataframe","clientProjectAddDataframe","clientProjectEditDataframe","vueClientProjectDataframe",  "vueGettingStartedDataframe", "vueCareersDataframe","vueElintegroApplicantsDataframe",
