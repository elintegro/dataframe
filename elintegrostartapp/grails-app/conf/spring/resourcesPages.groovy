...
beans {
	...
	gcMainPageVue(PageDFRegistryVue){ bean ->
		...
		allDataframesList = [
				...
				"vueTechnologiesDataframe","vueClientProjectDataframe","vueCreateProjectForTranslationDataframe","vueEditTranslatedRecordsOfGridDataframe","vueGoogleTranslateRecordsOfGridDataframe","vueGridOfTranslatedTextDataframe","vueTranslatorDataframe","vueTranslatorAssistantDataframe","vueElintegroSubMenuDataframe","vueElintegroAppsDataframe","vueGettingStartedDataframe", "vueCareersDataframe","vueElintegroApplicantsDataframe",
